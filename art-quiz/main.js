    ...
    this.quizCategories.forEach(quizCategory => {
      quizCategory.addEventListener('click', (e) => {
        if (e.currentTarget === quizCategory) {
          ...
          new Question(raund, this.isArtist, this.counter, 0, number, this.categoryText).setQuestion()
          this.quiz.classList.remove('active')
        }
      ...
      answers.forEach(answer => {
        ...
        answer.addEventListener('click', (e) => {
          ...
          if (e.target === answer && e.target.textContent === raundObj.author) {
            ...
            new Popup(this.score, raundObj, true, this.category, this.isArtist, this.counter, this.quizQuestions, this.number, this.categoryText).setPopup()
          } else {
            answer.classList.add('wrong-answer')
            pointsArr.push('point__wrong')
            answersArr[this.number].push('point__wrong')
            points[this.counter].classList.add('point__wrong')
            new Popup(this.score, raundObj, false, this.category, this.isArtist, this.counter, this.quizQuestions, this.number, this.categoryText).setPopup()
          }
        })
      })
  ...
  setPopup() {
    ...
    if (this.counter < 10) {
      popupNextBtn.addEventListener('click', () => {
        ...
        new Question(this.category, this.isArtist, this.counter, this.score, this.number, this.categoryText).setQuestion()
      })
    } else {
      popupNextBtn.addEventListener('click', () => {
        this.popup.innerHTML = `
        ...
        popupNextQuizBtn.addEventListener('click', () => {
          ...
          this.popup.classList.remove('active')
          pointsArr = []
          new Category(this.isArtist, 0, this.categoryText).setCategory()
        })
